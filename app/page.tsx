    ...
    <div>
      ...
      <div>
        <div className="w-full flex justify-end mt-3 mb-3">
          <input type="text" onChange={(e) => setSearch(e.target.value)} placeholder="search users" className="p-3 w-[300px] mr-5 border border-slate-500 outline-none rounded-sm" />
        </div>
